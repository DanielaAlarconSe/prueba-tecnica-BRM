...
class VinoController {
            ...
            if (listaVino) {
                Marca.findAll().then(listaMarca => {
                    res.render('administrador', {
                        titulo: 'Santos Licores | Vinos', fragmento: 'fragments/frm_vino',
    ...
    cargarPrincipal(req, res) {
        Vino.findAll({ include: [{ model: Marca, required: true }] }).then(listaVino => {
            if (listaVino) {
                ...
                res.render('administrador', {
                    titulo: 'Santos Licores | Administración', fragmento: 'fragments/frm_principal',
                    listaVino: listaVino
                });
            }
        }).catch(err => {
    ...
    verFoto(req, res) {
        res.render('administrador', {
            titulo: 'Santos Licores | Fotos', fragmento: 'fragments/frmFoto',
